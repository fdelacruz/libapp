Feature: Reader Registration
  ...
  which consists only from email, password and confirm password firlds 
  and a button. After registration reader is logged in and ready to work 
  with application.
  ...
  Scenario: Reader tries to register with invalid data
    ...
    Then I should see the register for again
